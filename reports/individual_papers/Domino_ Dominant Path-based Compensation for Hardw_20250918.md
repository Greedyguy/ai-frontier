...
**Links**: [[daily/2025-09-18|2025-09-18]] [[keywords/evolved/Delay-domain processing|Delay-domain processing]] [[keywords/broad/WiFi sensing|WiFi sensing]] [[keywords/broad/Channel impulse response|Channel impulse response]] [[keywords/specific/Automatic gain control|Automatic gain control]] [[keywords/unique/Domino|Domino]] [[categories/cs.NI|cs.NI]]

## 🏷️ 카테고리화된 키워드
**🚀 Evolved Concepts**: Delay-domain processing
**🔬 Broad Technical**: WiFi sensing, RF distortions
**🔗 Specific Connectable**: Channel impulse response
**⭐ Unique Technical**: Domino

**ArXiv ID**: [2509.13807](https://arxiv.org/abs/2509.13807)
**Published**: 2025-09-18
**Category**: cs.NI
**PDF**: [Download](https://arxiv.org/pdf/2509.13807.pdf)
